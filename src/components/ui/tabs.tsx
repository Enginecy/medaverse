  ...
  return (
    <div className="relative h-full" ref={tabsListRef}>
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          `bg-muted text-muted-foreground relative inline-flex w-fit
...
TabsLinkTrigger.displayName = TabsTrigger.displayName;
...
export { Tabs, TabsContent, TabsList, TabsTrigger, TabsLinkTrigger };
